...
export default function Edit({ profile, updateUrl, passwordUrl, destroyUrl, linkedUsers, pendingEmailChange, timezones }) {
    ...
    return <AuthenticatedLayout>
        ...
        <section className="mx-auto max-w-4xl space-y-6" data-testid="profile-edit">
            <div><h1 className="text-3xl font-extrabold text-slate-900">Configuración de cuenta</h1><p className="mt-2 text-slate-500">Gestiona tu información personal y seguridad de forma segura.</p></div>
